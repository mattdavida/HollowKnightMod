...
namespace HollowKnight.Core
{
    ...
    public class ConfirmationSystem
    {
        ...
        public void ShowConfirmation(string actionName, string message, System.Action action)
        {
            ...
            if (UnityEngine.Time.time < modalCooldownTime)
            {
                return;
            }
        ...
        public void RenderModal()
        {
            ...
            if (solidBlackTexture == null)
            {
                ...
                solidBlackTexture.SetPixel(0, 0, new Color(0, 0, 0, 0.3f)); // Light overlay (30% opacity)
        ...
        public void CloseModal()
        {
            ...
            pendingAction = null;
            modalCooldownTime = UnityEngine.Time.time + 0.2f;
        }
